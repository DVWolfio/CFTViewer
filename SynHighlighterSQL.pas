...
//---Oracle---------------------------------------------------------------------
  ...
  OracleKW: UnicodeString =
    ...
    'DROP,DRS_START,ELSE,ELSEIF,ENABLE,ENQUEUE_RESOURCES,ESCAPE,ESTIMATE,EVENT,' +
    ...
    'WORKAREA_SIZE_POLICY,RTL,STDIO';
...
//---Postgresql-----------------------------------------------------------------
  ...
  OraclePLSQLKW: UnicodeString =
    ...
    'NUMBER_BASE,OPEN,OUT,PACKAGE,PARALLEL_ENABLE,PARTITION,PASCAL,' +
  ...
  OracleSQLPlusCommands: UnicodeString =
    ...
    'BTI,BTITLE,BUFFER,CLEAR,CLOSECURSOR,CMDS,CMDSEP,COL,COLSEP,COM,COMP,' +
